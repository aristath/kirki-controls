...
kirki.control.type['color-palette'] = kirki.control.type['kirki-color-palette'] = 'colorPaletteControl';
 ...
 * @returns {string}
 */
kirki.control.template.colorPaletteControl = function( control ) {
	var html    = '',
		inputWrapperClasses;
 ...
 * @returns {void}
 */
kirki.control.value.set.colorPaletteControl = function( control, value ) {
