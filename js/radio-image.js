...
kirki.control.type['radio-image'] = kirki.control.type['kirki-radio-image'] = 'radioImageControl';
 ...
 * @returns {string}
 */
kirki.control.template.radioImageControl = function( control ) {
	var html = '';
 ...
 * @returns {void}
 */
kirki.control.value.set.radioImageControl = function( control, value ) {
