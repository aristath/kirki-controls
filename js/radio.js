...
kirki.control.type.radio = kirki.control.type['kirki-radio'] = 'radioControl';
 ...
 * @returns {string}
 */
kirki.control.template.radioControl = function( control ) {
	var html = '';
 ...
 * @returns {void}
 */
kirki.control.value.set.radioControl = function( control, value ) {
