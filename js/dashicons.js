...
kirki.control.type.dashicons = kirki.control.type['kirki-dashicons'] = 'dashiconsControl';
 ...
 * @returns {string}
 */
kirki.control.template.dashiconsControl = function( control ) {
	var html    = '',
		data    = control.params,
 ...
 * @returns {void}
 */
kirki.control.value.set.dashiconsControl = function( control, value ) {
