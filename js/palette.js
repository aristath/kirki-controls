...
kirki.control.type.palette = kirki.control.type['kirki-palette'] = 'paletteControl';
 ...
 * @returns {string}
 */
kirki.control.template.paletteControl = function( control ) {
	var html = '';
 ...
 * @returns {void}
 */
kirki.control.value.set.paletteControl = function( control, value ) {
