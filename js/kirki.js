				...
				rowTemplate = '<li class="repeater-row">';
					...
					rowTemplate += '<div class="row-content">';
						...
						_.each( control.params.fields, function( field, key ) {
							...
							if ( _.isUndefined( field.type ) || _.isUndefined( kirki.control.types[ 'kirki-' + field.type ] ) ) {
								field.type = 'generic';
							}
							...
							// Add the template.
							rowTemplate += kirki.control.template[ kirki.control.types[ 'kirki-' + field.type ] ]( field );
						} );
					rowTemplate += '</div>';
				rowTemplate += '</li>';
...
( function() {
	...
	wp.customize.kirkiDynamicControl = wp.customize.Control.extend( {
		...
		getHTML: function( control ) {
			return kirki.control.template[ kirki.control.types[ control.params.type ] ]( control );
		},
		...
		kirkiSetControlValue: function( value, key ) {
			var control = this;
			kirki.control.value.set[ kirki.control.types[ control.params.type ] ]( this, value );
		},
