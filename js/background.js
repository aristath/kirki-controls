...
kirki.control.type.background = kirki.control.type['kirki-background'] = 'backgroundControl';
 ...
 * @returns {string}
 */
kirki.control.template.backgroundControl = function( control ) {
 ...
 * @returns {void}
 */
kirki.control.value.set.backgroundControl = function( control, value ) {
