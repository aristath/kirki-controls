...
class Kirki_Control_Dashicons extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-dynamic-control', trailingslashit( Kirki::$url ) . 'controls/assets/js/dynamic-control.js', array( 'jquery', 'kirki-dynamic-control', 'customize-base' ), false, true );
		wp_enqueue_script( 'kirki-dashicons', trailingslashit( Kirki::$url ) . 'controls/assets/js/dashicons.js', array( 'jquery', 'customize-base' ), false, true );
		wp_enqueue_style( 'kirki-dashicons-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/dashicons.css', null );
	}
