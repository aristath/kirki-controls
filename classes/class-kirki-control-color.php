...
class Kirki_Control_Color extends Kirki_Control_Base {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'kirki-color', Kirki_Controls_Bootstrap::get_url( 'assets/js/color.js' ), array( 'jquery', 'customize-base', 'kirki-dynamic-control', 'wp-color-picker-alpha' ), false, true );
