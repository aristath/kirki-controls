...
class Kirki_Control_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-slider', trailingslashit( Kirki::$url ) . 'controls/assets/js/slider.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control' ), false, true );
		wp_enqueue_style( 'kirki-slider-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/slider.css', null );
	}
