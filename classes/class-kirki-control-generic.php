...
class Kirki_Control_Generic extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-generic', trailingslashit( Kirki::$url ) . 'controls/assets/js/generic.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control' ), false, true );
		wp_enqueue_style( 'kirki-generic-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/generic.css', null );
	}
