...
class Kirki_Control_Radio_Buttonset extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-radio-buttonset', trailingslashit( Kirki::$url ) . 'controls/assets/js/radio-buttonset.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control' ), false, true );
		wp_enqueue_style( 'kirki-radio-buttonset-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/radio-buttonset.css', null );
	}
