...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-image', trailingslashit( Kirki::$url ) . 'controls/assets/js/image.js', array( 'jquery', 'customize-base' ) );
		wp_enqueue_style( 'kirki-image', trailingslashit( Kirki::$url ) . 'controls/assets/css/image.css', null );
	}
