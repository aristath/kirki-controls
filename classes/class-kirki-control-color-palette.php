...
class Kirki_Control_Color_Palette extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-color-palette', trailingslashit( Kirki::$url ) . 'controls/assets/js/color-palette.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control', 'jquery-ui-button' ), false, true );
		wp_enqueue_style( 'kirki-color-palette-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/color-palette.css', null );
	}
