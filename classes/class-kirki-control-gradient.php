...
class Kirki_Control_Gradient extends Kirki_Control_Base {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'kirki-gradient', trailingslashit( Kirki::$url ) . 'controls/assets/js/gradient.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control', 'wp-color-picker-alpha' ), false, true );
		wp_enqueue_style( 'kirki-gradient-css', trailingslashit( Kirki::$url ) . 'controls/assets/css/gradient.css', null );
