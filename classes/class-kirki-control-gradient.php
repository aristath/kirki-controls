...
class Kirki_Control_Gradient extends Kirki_Control_Base {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'kirki-gradient', Kirki_Controls_Bootstrap::get_url( 'assets/js/gradient.js' ), array( 'jquery', 'customize-base', 'kirki-dynamic-control', 'wp-color-picker-alpha' ), false, true );
