...
class Kirki_Control_Repeater extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-repeater', Kirki_Controls_Bootstrap::get_url( 'assets/js/repeater.js' ), array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
