...
class Kirki_Controls_Bootstrap {
	...
	public function get_control_types() {
		return array(
			...
			'kirki-dimension'       => 'Kirki_Control_Base',
			...
			'kirki-multicheck'      => 'Kirki_Control_Base',
			'kirki-number'          => 'Kirki_Control_Number',
			'kirki-palette'         => 'Kirki_Control_Palette',
			'kirki-preset'          => 'Kirki_Control_Preset',
			'kirki-radio'           => 'Kirki_Control_Base',
			'kirki-radio-buttonset' => 'Kirki_Control_Base',
			'kirki-radio-image'     => 'Kirki_Control_Base',
			...
			'kirki-generic'         => 'Kirki_Control_Base',
